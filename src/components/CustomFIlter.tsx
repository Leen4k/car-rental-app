      ...
      <Listbox value={selected} onChange={(e)=> {setSelected(e); handleUpdateParams(e)}}>
        <div className="relative w-fit z-10">
          <Listbox.Button className="custom-filter__btn">
            ...
            <Image src="/chevron-up-down.svg" width={20} height={20} className="object-contain ml-4" alt="chevron up and down" />
          </Listbox.Button>
          <Transition as={Fragment} leave="trasition ease-in duration-100" leaveFrom="opacity-100" leaveTo="opacity-0">
